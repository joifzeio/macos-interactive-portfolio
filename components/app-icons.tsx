...
export const VSCodeIcon = () => (
  <div className="w-full h-full rounded-[22%] bg-[#1e1e1e] flex items-center justify-center overflow-hidden relative sharp-icon">
    <Image
...
export const GitHubIcon = () => (
  <div className="w-full h-full rounded-[22%] bg-[#181717] flex items-center justify-center shadow-lg sharp-icon overflow-hidden relative">
    ...
    <svg viewBox="0 0 24 24" className="w-3/4 h-3/4 fill-white relative z-10">
